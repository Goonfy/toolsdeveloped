package org.academiadecodigo.bootcamp54.stringmanipulations;
...
public class Main {
    public static void main(String[] args)
    {
        ...
        name = "< " + domain.substring(4, 12).replaceFirst("a", "A") + " " + domain.substring(12, 14)
                + " " + domain.substring(14, 20).replaceFirst("c", "C") + "_ >";
